<template>
<<<<<<< HEAD
    <div id = "signUpButton" v-if="token == null || token.length == 0 || token == 'undefined'" >
        <button type = "button" v-on:click = "SignUpPageLink">Sign Up</button>
    </div>
=======
  <div
    id="signUpButton"
  ...
  >
    <button class="button" type="button" v-on:click="SignUpPageLink">Sign Up</button>
  </div>
