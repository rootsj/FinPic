<template>
<<<<<<< HEAD
    <div id = "logOutButton" v-if="token != null && token.length != 0 && token != 'undefined'" >
        <button type = "button" v-on:click = "LogOutLink">Log Out</button>
    </div>
=======
  <div
    id="logOutButton"
  ...
  >
    <button type="button" class="button" v-on:click="LogOutLink">Log Out</button>
  </div>
